...
`V3/life_eq_v3` is a non-destructive variant suite built from the current `V2/life_eq_v2` implementation.
...
```python
from V3.life_eq_v3.factory import build_model

model = build_model("phase3_modules_decisions")
```

Or import a concrete variant file from `V3/life_eq_v3/variants/`.
